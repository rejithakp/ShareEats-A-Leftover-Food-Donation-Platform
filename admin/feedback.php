...
<body>
    ...
    <section class="dashboard">
        ...
        <div class="top">
            ...
            <!-- <p>Food Donate</p> -->
            <p  class ="logo" >User Feed<b style="color: #06C167; ">back</b></p>
             <p class="user"></p>
       ...
       ?> 
        ...
        <br>
        <br>
        <p class ="logo" >Agent Feed<b style="color: #06C167; ">back</b></p>
     ...
     <tbody>
      ...
      if($result==true){
          while($row=mysqli_fetch_assoc($result)){
              echo "<tr><td data-label=\"name\">".$row['name']."</td><td data-label=\"email\">".$row['email']."</td><td data-label=\"message\">".$row['feedback']."</td><td data-label=\"message\">".$row['date']."</td></tr>";
