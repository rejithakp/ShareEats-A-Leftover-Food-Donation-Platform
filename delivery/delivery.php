...
<body>
<header>
        <div class="logo">Share<b style="color: #c1060f;">Eats.</b></div>
        <div class="hamburger">
            <div class="line"></div>
            <div class="line"></div>
            <div class="line"></div>
        ...
        <nav class="nav-bar">
            <ul>
                ...
                <li><a href="orphanage.php" >Orphanages</a></li>
                <li><a href="orphanage_update.php" >Add Orphanages</a></li>
                <li><a href="feedback_agent.php" >Feedback</a></li>
...
$sql = "SELECT fd.Fid AS Fid,fd.location as cure,fd.deliver_to as deliverto,fd.name,fd.phoneno,fd.date,fd.delivery_by,fd.address as From_address, 
...
<div class="table-container">
       ...
       <tbody>
        ...
        <?php    echo "<tr><td data-label=\"name\">".$row['name']."</td><td data-label=\"phoneno\">".$row['phoneno']."</td><td data-label=\"date\">".$row['date']."</td><td data-label=\"Pickup Address\">".$row['From_address']."</td><td data-label=\"Delivery Address\">".$row['deliverto']."</td>";
?>
